...
insert into Quote (User_Id, Cust_Mail, Cust_Id, SNote, Status)
  values (2, '420swagmaster@hotmail.co.uk', 1, "This person's email got me a free water bottle", "Finalized");
insert into Quote (User_Id, Cust_Mail, Cust_Id, SNote, Status)
  values (1, 'customerEmail@email.com', 2, "Ryan's secret notes for his first quote", "Sanctioned");
insert into Quote (User_Id, Cust_Mail, Cust_Id, SNote, Status)
  values (6, 'mcdonalds@email.com', 3, "McDonalds is aiiight", "Ordered");
insert into Quote (User_Id, Cust_Mail, Cust_Id, SNote, Status)
  values (5, 'burgerKing@email.com', 4, "Burger king has decent burgers", "Finalized");
insert into Quote (User_Id, Cust_Mail, Cust_Id, SNote, Status)
  values (4, 'wendys@email.com', 5, "I hardly go to wendys. Not sure why", "Ordered");
insert into Quote (User_Id, Cust_Mail, Cust_Id, SNote, Status)
  values (10, 'buffaloWildWings@email.com', 6, "Mmmm smoky adobo", "Sanctioned");
